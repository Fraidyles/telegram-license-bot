...
templates = {
    "GP": "...(вставь текст GP)...",
    "BT": "...(вставь текст BT)...",
    "GD Полина Ганжара": "...(вставь текст Ганжара)...",
    "GD Ксения Исламова": "...(вставь текст Исламова)...",
    "Specialist Гинеколог": "...(вставь текст Гинеколог)...",
    "Резидентура": "...(вставь текст Резидентура)..."
}
...
programs = {
    "GP": "...(программа GP)...",
    "BT": "...(программа BT)...",
    "GD Полина Ганжара": "...(программа Ганжара)...",
    "Specialist Гинеколог": "...(программа Гинекология)...",
    "Spec Дерматолог": "...",
    "Spec Кардиолог": "..."
}
